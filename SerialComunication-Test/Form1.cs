...
namespace SerialComunication_Test
{
    ...
    public partial class Form1 : Form
    {
        ...
        private void btnCheckCOM_Click(object sender, EventArgs e)//检查可用串口
        {
            ...
            if (comExistence)
            {
                cbxCOMPort.SelectedIndex = 0;//使ListBox 显示第1 个添加的索引
            }
            else
            {
        ...
        private bool CheckSendData()//检查发送区数据是否有数据
        {
        ...
        private void btnOpenCom_Click(object sender, EventArgs e)//打开串口
        {
            if (isOpen == false)
            {
        ...
        private void sp_DataReceived(object sender, SerialDataReceivedEventArgs e)//数据接收
        {
